...
// Owner & Bot Details
global.owner = process.env.OWNER_NUMBER || "+92 31902 17441";
global.anitav4 = process.env.BOT_NAME || "N.HASAN_v4";
global.ownername = process.env.OWNER_NAME || "ɴᴏᴏʙ ʜᴀxᴏʀツ";
global.packname = process.env.PACK_NAME || "ɴᴏᴏʙ ʜᴀxᴏʀツ";
global.author = process.env.AUTHOR || "ɴᴏᴏʙ ʜᴀxᴏʀツ";
global.channelname = process.env.CHANNEL_NAME || "ɴᴏᴏʙ ʜᴀxᴏʀツ";
